...
export default class Carteira {
    ...
    getValidade() { return (this.#validade); }
    setValidade(validade) { this.#validade = validade; }
    ...
    getCarteiraHash() { return (this.#carteiraHash); }
    setCarteiraHash(carteiraHash) { this.#carteiraHash = carteiraHash; }
}//end class